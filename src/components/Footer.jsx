    ...
    <footer className="bg-gray-900 text-white pt-10 pb-6 px-4 sm:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 bg-gradient-to-r from-gray-800 to-gray-700 rounded-xl p-6 shadow-lg">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="tel:+8801759676488" className="flex items-center gap-2 hover:text-green-400">
                  <FaPhoneAlt /> +8801759676488
                </a>
              </li>
              <li>
                <a href="mailto:rumuislam202@gmail.com" className="flex items-center gap-2 hover:text-green-400">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300">
              I am a passionate web developer with experience in creating responsive and dynamic websites.
            </p>
          </div>
        ...
        <div className="text-center mt-8 text-sm text-gray-400">
          &copy; 2025 <span className="text-green-500">Roman-oze</span>. All rights reserved.
        </div>
      </div>
    </footer>
  );
