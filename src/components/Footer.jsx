...
const Header = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[rgba(15,15,15,0.85)] backdrop-blur-md border-b border-white/10 shadow-md">
            ...
            {['Home', 'Profile', 'Academic', 'Certificate', 'Achievement', 'Skill', 'Contact'].map((item) => (
              <li key={item}>
                <a
                  ...
                  className="relative text-green-600 font-semibold text-[1.1rem] tracking-wide py-2 hover:text-green-100 transition-all duration-300 before:absolute before:bottom-0 before:left-1/2 before:w-0 before:h-[2px] before:bg-green-100 before:transition-all before:duration-300 hover:before:w-full hover:before:left-0"
                >
                  {item}
                </a>
              </li>
